...
void COSMCtrl::HandleLButtonDblClickCircle(UINT /*nFlags*/, CPoint /*point*/, MapItem /*item*/, INT_PTR nItem, INT_PTR /*nSubItem*/)
{
	...
	pMapView->SearchLoad(circle.relatedBus);
	double xTime[24];
	for (int i = 0; i < 24; i++)
		xTime[i] = i;

	pTableView->DrawLineGraph(24, xTime, pMapView->m_load);

	StationStruct station;
	station = pMapView->pDoc->m_Stations[circle.relatedBus];

	//Change text in InfoView
...
//void COSMCtrlAppView::OnRButtonDblClk(UINT nFlags, CPoint point)
//{
//	// TODO:  在此添加消息处理程序代码和/或调用默认值
//	CMainFrame *pFrame = (CMainFrame *)AfxGetMainWnd();
//	CTableView* pTableView = (CTableView *)pFrame->pFunctionView;
//	COSMCtrlAppView* pMapView = (COSMCtrlAppView*)pFrame->pMapView;
//
//	double xTime[24];
//	for (int i = 0; i < 24; i++)
//		xTime[i] = i;
//
//	double *xxxxx = pMapView->m_load;
//	pTableView->DrawLineGraph(24, xTime, xTime);
...
//void COSMCtrlAppView::DblClickCircleView(int relatedBus)
//{
//	CMainFrame *pFrame = (CMainFrame *)AfxGetMainWnd();
//	CTableView* pTableView = (CTableView *)pFrame->pFunctionView;
//	SearchLoad(relatedBus);
//	double xTime[24];
//	for (int i = 0; i < 24; i++)
//		xTime[i] = i;
//
...
void COSMCtrlAppView::EVCalculate()
{
